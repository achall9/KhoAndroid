package com.kholabs.khoand.CustomView.NavigationView;
 ...
 */
public class BottomNavigationEx extends BottomNavigationView {
    // used for animation
    ...
    public BottomNavigationEx(Context context) {
        super(context);
//        init();
    }

    public BottomNavigationEx(Context context, AttributeSet attrs) {
        super(context, attrs);
//        init();
    }

    public BottomNavigationEx(Context context, AttributeSet attrs, int defStyleAttr) {
...
//        System.out.println("mMenuView:" + mMenuView + " mButtons:" + mButtons + " mOnClickListener" + mOnClickListener);
     ...
     * necessary calls back to the provided {@link BottomNavigationEx} so that the tab position is
     * kept in sync.
     * <p>
    ...
    private static class BottomNavigationViewExOnPageChangeListener implements ViewPager.OnPageChangeListener {
        private final WeakReference<BottomNavigationEx> mBnveRef;

        public BottomNavigationViewExOnPageChangeListener(BottomNavigationEx bnve) {
        ...
        public void onPageSelected(final int position) {
            final BottomNavigationEx bnve = mBnveRef.get();
...
//            Log.d("onPageSelected", "--------- position " + position + " ------------");
    ...
    private static class MyOnNavigationItemSelectedListener implements OnNavigationItemSelectedListener {
        ...
        MyOnNavigationItemSelectedListener(ViewPager viewPager, BottomNavigationEx bnve, boolean smoothScroll, OnNavigationItemSelectedListener listener) {
