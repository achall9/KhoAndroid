...
public class SupportingFragment extends FragmentBase implements FeedListAdapter.FeedListItemListener,
        MainActivity.onKeyBackPressedListener
{
    ...
    public static SupportingFragment newInstance(String param1, String param2) {
        SupportingFragment fragment = new SupportingFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if (rootView == null)
        {
            rootView = inflater.inflate(R.layout.fragment_supporting, container, false);
    ...
    private void reloadData(boolean isDialogShow)
    {
        ...
        if (loadCount > 0)
        {
            ...
            query.findInBackground(new FindCallback<ParseObject>() {
                @Override
                public void done(List<ParseObject> Supports, ParseException e) {
                    if (e != null || Supports == null || Supports.size() == 0) {
                    ...
                    {
                        ParseObject post = Supports.get(i).getParseObject("post");
                        if (post == null)
                            continue;
                        Feed item = GetDataFromParseObject(post, i);
                        addItems.add(item);
                    }
