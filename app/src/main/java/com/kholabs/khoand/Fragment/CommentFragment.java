...
public class CommentFragment extends FragmentBase implements FeedListAdapter.FeedListItemListener,
        ...
        if (loadCount > 0)
        {
            ...
            query.findInBackground(new FindCallback<ParseObject>() {
                ...
                public void done(List<ParseObject> Comments, ParseException e) {
                    if (e != null || Comments == null || Comments.size() == 0) {
                    ...
                    {
                        ParseObject post = Comments.get(i).getParseObject("post");
                        if (post != null)
                        {
