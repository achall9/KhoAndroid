...
public class AthleteSignupActivity extends ActivityBase implements ConstValues, View.OnClickListener{
    ...
    private void getUIObjects()
    {
        ...
        llSignup.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                //AthleteSignupActivity.this.finish();
                if (verifyReqFields())
        ...
        query.findInBackground(new FindCallback<ParseObject>()
        {
            ...
            public void done(List<ParseObject> objects, ParseException e) {
                if(e == null)
                {
                    ...
                    {
                        AlertDialog alertDialog = new AlertDialog.Builder(AthleteSignupActivity.this).create();
        ...
        user.signUpInBackground(new SignUpCallback() {
            ...
            public void done(ParseException e) {
                if (e == null) {
                    ...
                    Intent intent = new Intent(AthleteSignupActivity.this, StartActivity.class);
    ...
    private Boolean verifyReqFields()
    {
        ...
        Animation shake = AnimationUtils.loadAnimation(AthleteSignupActivity.this, R.anim.shake);
        ...
        {
            AlertDialog.Builder builder = new AlertDialog.Builder(AthleteSignupActivity.this, android.R.style.Theme_Holo_Light_Dialog);
    ...
    void alertDisplayer(String title, String message) {
        AlertDialog.Builder builder = new AlertDialog.Builder(AthleteSignupActivity.this, AlertDialog.THEME_HOLO_LIGHT);
        TextView myMsg = new TextView(this);
