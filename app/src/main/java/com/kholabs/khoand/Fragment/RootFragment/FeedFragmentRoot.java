...
import com.kholabs.khoand.Fragment.FeedSearchFragment;
...
public class FeedFragmentRoot extends Fragment {
    public static final String ARG_OBJECT = "object";//testing

    public FeedFragmentRoot() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootview = inflater.inflate(R.layout.fragment_feed_fragment_root, container, false);
        Bundle args = getArguments();
        FragmentTransaction transaction = getFragmentManager().beginTransaction();
        transaction.add(R.id.feed_root_frame, new FeedFragment());
        transaction.commit();
